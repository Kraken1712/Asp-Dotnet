...
namespace MonSite.Web.Controllers
{
    public class BlogsController : Controller
    {
        private readonly MonSiteContext _context;

        public BlogsController(MonSiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Blogs != null ? 
                          ...
                          Problem("Entity set 'MonSiteContext.Blogs'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MonSiteContext.Blogs'  is null.");
            }
            var blog = await _context.Blogs.FindAsync(id);
            if (blog != null)
            {
